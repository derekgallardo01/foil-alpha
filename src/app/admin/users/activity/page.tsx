    ...
    return (
        ...
        >
            ...
            <Box sx={{ display: "flex", alignItems: "center", p: 2, borderBottom: '1px solid rgba(150, 255, 155, 0.2)' }}>
                ...
                <Typography variant="h5" sx={{ color: '#96ff9b', fontWeight: 'bold', ml: 2 }}>
                    User Activity
                </Typography>
                <Box sx={{ ml: 'auto' }}>
                    <IconButton onClick={fetchActivities} sx={{ color: '#96ff9b' }}>
                        <RefreshIcon />
                    </IconButton>
                </Box>
            </Box>
                ...
                <Paper sx={{ bgcolor: 'grey.800', border: '1px solid rgba(150, 255, 155, 0.2)' }}>
                    <TableContainer>
                        <Table>
                            <TableHead>
                                <TableRow>
                                    <TableCell sx={{ color: '#96ff9b' }}>User</TableCell>
                                    <TableCell sx={{ color: '#96ff9b' }}>Action</TableCell>
                                    <TableCell sx={{ color: '#96ff9b' }}>Timestamp</TableCell>
                                    <TableCell sx={{ color: '#96ff9b' }}>Details</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                    ...
                                    <TableRow key={activity.id}>
                                        <TableCell>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                <Avatar sx={{ width: 32, height: 32, bgcolor: '#96ff9b', color: 'grey.900' }}>
