    ...
    <Container>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', my: 3 }}>
        <Image
          ...
          alt="App Logo"
          width={240} // Set appropriate width (adjust based on your needs)
      ...
      <Grid container spacing={2}>
        ...
        {/* Optional: Reintroduce users table here for admin users */}
        {/* Example:
                    ...
                    <TableBody>
                      {users.map((user) => (
                        <TableRow key={user.id}>
                          <TableCell>{capitalizeName(user.name)}</TableCell>
