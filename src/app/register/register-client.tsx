...
// src/app/register/register-client.tsx - Updated with dev bypass
"use client";
...
export default function RegisterClient() {
  ...
  const handleSuccess = (email: string, data: any) => {
    ...
    if (devMode && data.autoVerified) {
      ...
      toast.success("Registration successful! Auto-verified for development. You can now login.", { autoClose: 3000 });
      setTimeout(() => {
                ...
                <motion.div variants={itemVariants}>
                  <Alert severity="info" sx={{ mb: 3 }}>
                    <Typography variant="body2">
                      🚧 <strong>Development Mode:</strong> New accounts will be automatically verified and can login immediately - no email verification required!
                    </Typography>
                  </Alert>
                </motion.div>
              )}
